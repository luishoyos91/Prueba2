  ...
  <section>
      <article>
        <div class ="container">
            ...
            <br>
            <br>
            <a href="actualizar.php"> <img src="iconos/update-user.svg" class="icono_eliminar float-right" alt="icono_eliminar" title="Crear País"></a>
        <table class="table table-hover table-striped table-responsive" id="tabla_usuarios">
            ...
            <?php
                    $consulta = "SELECT u.id,u.nombre,u.apellido,u.documento,u.edad,r.nombre_rol FROM usuarios U
